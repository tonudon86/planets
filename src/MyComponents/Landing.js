...
function Landing() {
   ...
   <section id="moonlight-section" >
		...
		<div className="home-btn-content">
			...
			<h4 className="home-page-h-four">Capture Your Cherished Memories in a Frame</h4>

			<button className="home-btnn" id="map"><Link to="/customization">GET YOUR STARMAP</Link></button>
		</div>
	...
	<section className="gift">
		<div className="star-gift">
			...
			<div className="star-gift-content star-add-div">
				...
				<span><img src="/img/Rectangle 33.png" alt="" className="gift-span secont-gift-span"/></span>
